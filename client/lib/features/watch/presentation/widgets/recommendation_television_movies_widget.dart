...
class RecommendationTelevisionMoviesWidget extends StatelessWidget {
  final int televisionMovieId;
  const RecommendationTelevisionMoviesWidget({
    required this.televisionMovieId,
    super.key,
  });
      ...
      create:
          (context) =>
              GenericDataCubit()..getGenericData<List<TelevisionEntity>>(
                serviceLocator<GetRecommendationTelevisionMoviesUseCase>(),
